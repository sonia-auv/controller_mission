...
class Arm(MissionState):
    ...
    def __init_(self):
        ...
        self.action_dic = {'0': self.action.CLOSE_ARM, '1': self.action.OPEN_ARM}
    ...
    def initialize(self):
        ...
        try:
            ...
            self.do_action(self.action.ELEMENT_ARM, self.action_dic[str(int(self.param_id))], self.action.ACTION_ARM_EXEC)
